      ...
      <b-tabs v-model="tabIndex" fill>
        <b-form inline class="ml-3 mr-3">
              <b-tab title="Group details" active>
                      ...
                      <strong class="text-underline">This section has your group information.</strong>
                      <b-row>
                      <!-- <b-col class="mt-4" sm="4">
                        <label class=" form-label " for="country">Country</label>
                        <b-input-group class="mb-3 mr-1 mb-sm-3 ">
                              <multiselect :selected="opt => countries.find(x => x.name == this.group_data.country)" v-model="form.country_id" v-validate="'required'" name="country"
                      ...
                      <b-form-group>
                        <b-input-group class="mb-3 mr-1 mb-sm-3 ">
                        <b-form-input v-validate="'required'" name="group-name" v-model="form.group_name" class="white-input-text" id="inline-form-input-name" ></b-form-input>
                      </b-input-group>
                      ...
                      <!-- <b-col class="mt-4" sm="4">
                        <label class=" form-label" for="inline-form-input-sponso">Cover/sponsor</label>
                      <b-input-group class="mb-3 mr-1 mb-sm-3 ">
                        <b-form-input v-validate="'required'" name="cover-sponsor" v-model="form.cover_sponsor" class="white-input-text" id="inline-form-input-sponsor" placeholder="Sponsor organization"></b-form-input>
                      </b-input-group>
                      ...
                      <b-input-group class="mb-3 mr-1 mb-sm-3 ">
                        <b-form-input  :value="group_data.noOfMaleMembers"  v-validate="'required'" name="male-members" v-model="form.male_members_count" type="number" class="white-input-text" id="inline-form-input-males" placeholder="Number of males"></b-form-input>
                      </b-input-group>
                      ...
                      <b-col sm="12" class="mt-2 mb-3">
                          ...
                          <b-col class="mt-4" sm="4">
                              <label class=" form-label" for="inline-form-input-firstname">Name</label>
                            <b-input-group class="mb-3 mr-1 mb-sm-3 ">
...
import { required, minLength } from "vuelidate/lib/validators";
  ...
  methods: {
      ...
      axios.post(this.apiUrl + 'Registration/GetGroupData', {groupId: this.group_id}).then( response => {
        t.group_data = response.data.response_data;
        let group = response.data.response_data;
        t.form.group_name = group.groupName;
        t.form.cover_sponsor = group.coverSponsor;
        t.form.male_members_count = group.noOfMaleMembers;
        t.form.female_members_count = group.noOfFemaleMembers;
        t.form.group_admin_first_name = group.adminName;
        t.form.group_admin_email = group.adminEmail;
        t.form.group_admin_phone_no = group.adminPhoneNo;
        t.form.has_been_audited = group.hasBeenAudited;
        t.form.auditing_date = group.lastAuditDate;
      })
    },
    getCountries() {
