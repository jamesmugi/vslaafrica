  ...
  <div>
      ...
      <b-row class="mb-3">
          <div class="col-sm-12 col-lg-6">
                <h3 class="page-title float-left"> Countries&nbsp;</h3>
          </div>
          <div class="col-sm-12 col-lg-6">
              <b-button class="float-right round-button" variant="outline-primary" v-b-modal.modal-1>Add country</b-button>
          </div>
          <b-modal id="modal-1" title="Add country" @ok="addEntry">
            <b-form>
      ...
      <div sm="12" class="mt-4">
          <h4>Countries</h4>
            <b-table responsive striped hover :items="countries" :fields="fields">
...
import axios  from 'axios';
  ...
  methods: {
    ...
    addEntry()
    {
      axios.post(this.apiUrl + 'Setup/AddCountry', this.form).then( response => {
