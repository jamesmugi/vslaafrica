  ...
  <div>
      ...
      <b-row class="mb-3">
          <div class="col-sm-12 col-lg-6">
                <h3 class="page-title float-left"> Loan utilizations&nbsp;</h3>
          </div>
          <div class="col-sm-12 col-lg-6">
              <b-button class="float-right round-button" variant="outline-primary" v-b-modal.modal-1>Add loan utilization</b-button>
          </div>
          <b-modal id="modal-1" title="Add loan utilization" @ok="addEntry">
            <b-form>
      ...
      <div sm="12" class="mt-4">
          <h4>Loan utilizations</h4>
            <b-table responsive striped hover :items="loanutilizations" :fields="fields">
...
import am4themes_animated from "@amcharts/amcharts4/themes/animated";
  ...
  methods: {
    ...
    addEntry()
    {
      axios.post(this.apiUrl + 'Setup/AddLoanUtilization', this.form).then( response => {
